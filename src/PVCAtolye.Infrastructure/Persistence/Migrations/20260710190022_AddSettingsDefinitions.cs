...
{
    /// <inheritdoc />
    public partial class AddSettingsDefinitions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_accessory_types", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_color_definitions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuoteFooterNote = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_number_sequence_settings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_profile_series", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_accessory_types_Code",
                table: "accessory_types",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_color_definitions_Code",
                table: "color_definitions",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_glass_types_Code",
                table: "glass_types",
                column: "Code",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_number_sequence_settings_DocumentType",
                table: "number_sequence_settings",
                column: "DocumentType",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_profile_series_Code",
                table: "profile_series",
                column: "Code",
                unique: true);
